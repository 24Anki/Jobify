          ...
          <div className="px-4 py-5 sm:p-6">
            ...
            <div>
              ...
              <div className="flex gap-x-4">
                <input
                  type="text"
                  className="block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6 w-1/2"
                  placeholder="Min"
                />
                <input
                  type="text"
          ...
          <div className="flex gap-x-4 mb-4">
            <div className="relative rounded-md shadow-sm w-80">
              ...
              <input
                ...
                name="email"
                id="email"
                className="block w-full h-10 rounded-md border-0 py-1.5 pl-10 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6"
          ...
          {jobs.map((job, index) => (
            <div
              ...
              className={`overflow-hidden rounded-lg bg-white shadow cursor-pointer ${
                index === 0 ? "border border-orange-600" : ""
              }`}
            >
              <div className="px-4 py-5 sm:p-6">
          ...
          <div className="px-4 py-5 sm:p-6 gap-4">
            ...
            <div className="flex gap-x-4 justify-between">
              <div className="rounded w-16 h-16 bg-gray-200 flex items-center justify-center">
                <BriefcaseIcon className="h-10 w-10 text-orange-600" />
              </div>
            ...
            <div className="flex gap-4 flex-col">
              <div className="flex gap-x-4 justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-400">12lakhs/yr</p>
                </div>
              </div>
              <button
                type="button"
                className="rounded-lg bg-orange-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600"
              >
                Apply Now
              </button>
            </div>
